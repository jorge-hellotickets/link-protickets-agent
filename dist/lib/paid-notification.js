...
export async function composePaidNotificationEmail(ctx, template, model) {
    const vars = {
...
export function resolvePaidNotificationLocale(locale) {
    return getLocaleConfig(locale);
}
//# sourceMappingURL=paid-notification.js.map